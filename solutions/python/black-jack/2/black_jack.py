...
def is_blackjack(card_one, card_two):
    ...
    value_cards = ["10", "J", "Q", "K"]

    if card_one in value_cards and card_two == "A":
        return True

    if card_two in value_cards and card_one == "A":
        return True
...
def can_split_pairs(card_one, card_two):
    ...
    if card_one in value_cards and card_two in value_cards:
        return True
